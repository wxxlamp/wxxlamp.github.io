...
![从 AI 夜校到七个 Agent 工程问题](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/1bbb01e7_section-1-v2.png)
...
![概率模型与确定性程序在生产系统中互补](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/d544d05d_section-2-v2.png)
...
![Model、Agent 与 Harness 的三层职责](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/8cffabe2_section-3-v2.png)
...
关于模型，可以参考我去年写的 [LLM 入门文章](https://wxxlamp.cn/2025/12/24/ai-ml-getting-started/)。简单讲，模型的核心仍然像“成语接龙”：基于海量参数，通过向量和矩阵运算，把 Prompt Token 作为输入，再逐步生成输出。多模态模型的机制也类似，只是输入和输出变成了经过特殊编码的图片、音频或视频 Token。
...
![Program、Skill 与 Subagent 的工程选型](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/e9159408_section-4.png)
...
![Agent 在开发、服务、学习和需求理解中的场景](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/a37b6bc8_section-5-v2.png)
...
![Agent 开发中的运行方式、流程与交互取舍](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/b16dbcdd_section-6.png)
...
![Agent 运行指标、业务标准、问题诊断和历史回归闭环](https://cdn.jsdelivr.net/gh/wxxlamp/blog-img-repo@main/images/7e849ca7_section-7.png)
...
第一，采集 `cache hit rate`、`TTFT`、`token cost`、`time cost` 等运行指标。没有这些数据，很难判断一次优化究竟改善了效果，还是只增加了成本。
...
你在 Agent 开发中更关心模型能力、工程系统，还是评测问题？欢迎留言交流。
