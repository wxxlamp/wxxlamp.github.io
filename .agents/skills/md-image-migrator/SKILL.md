...
```bash
python3 .Codex/skills/md-image-migrator/md-image-migrator.py <markdown文件> [选项]
```
...
**基础用法** (使用默认 GitHub 图床):
```bash
python3 .Codex/skills/md-image-migrator/md-image-migrator.py \
