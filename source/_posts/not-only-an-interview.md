...
categories:
   - 面试经验
description: "作者作为211本科生，在2020年实习招聘季同时拿到阿里Java和腾讯后台两个offer，本文系统分享了从考研与就业的两难抉择，到Java学习路径规划、项目实战积累，再到面试准备全流程的宝贵经历。文章详细列举了Java基础、JVM、并发、MySQL、Redis、SSM等核心面试知识点，并从简历撰写、面试心态到大厂面试流程等多维度提供实用建议，适合正在备战互联网校招的同学参考。"
---
