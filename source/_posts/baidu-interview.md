...
description: "记录一次百度秋招三轮面试的完整经历，涵盖Java基础（String、锁机制、集合）、IO模型（BIO/NIO）、线程状态与线程池、数据库索引与AQS原理、缓存一致性、分布式锁、Zookeeper集群发现、Spring AOP实现原理等核心知识点，并附有LRU缓存和对称二叉树的代码实现，适合秋招面试备考参考。"
---
