...
description: "大学四年所学知识的全面总结，分为专业能力、沟通能力和学习能力三大板块。专业能力从硬件、操作系统、编程语言、程序到业务逐层展开，深入讲解CPU/内存/IO原理、进程线程协程调度、C与Java内存模型对比及系统四大质量目标；沟通能力强调主动性与owner意识；学习能力则提倡带着目的、总结抽象、付诸实践的三步循环学习法。"
---
